TEMPLATE = app
TARGET = SHIELD-Qt
macx:TARGET = "SHIELD-Qt"
windows:TARGET = "SHIELD-Qt"
VERSION = 2.3.0.0
...
win32: {
  ...
  BOOST_INCLUDE_PATH=C:/TEMP/boost_1_57_0
  BOOST_LIB_PATH=C:/TEMP/boost_1_57_0/stage/lib
  ...
  MINIUPNPC_LIB_PATH=C:/TEMP/miniupnpc-1.9.20150206
  MINIUPNPC_INCLUDE_PATH=C:/TEMP
  QRCODE_LIB_PATH=C:/TEMP/qrencode-3.4.4/.libs
  QRCODE_INCLUDE_PATH=C:/TEMP/qrencode-3.4.4
...
#windows:LIBS += -lws2_32 -lole32 -loleaut32 -luuid -lgdi32 -lssleay32 -llibeay32
...
contains(RELEASE, 1) {
    ...
    macx:QMAKE_CXXFLAGS += -mmacosx-version-min=10.5 -arch x86_64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.7.sdk
...
macx:ICON = src/qt/res/icons/t-coin.icns
...
!windows:!macx {
  ...
  LIBS += -lm -ljpeg -L/usr/lib  -ldl -lstdc++ 
}
